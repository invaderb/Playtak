...
var materials = {
	...
	,table_tex_name:'images/wooden_table.png'
...
var pieceFactory = {
	makePiece:function(playerNum,pieceNum,scene){
		...
		// TODO set stack height
		var stackno = Math.floor(pieceNum / 5);
		var stackheight = pieceNum % 5;
...
var board = {
	...
	addtable: function() {
        var table_texture = new THREE.TextureLoader().load(materials.table_tex_name);
